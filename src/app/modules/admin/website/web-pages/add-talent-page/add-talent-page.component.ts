...
export class AddTalentPageComponent implements OnInit {
  ...
  //     if(key == 'banner_bg_img') continue;
  //     if(key == 'banner_imgs') continue;
  //     if(key == 'talent_section') continue;
  ...
  //   // formData.append(`this.formData.banner_imgs`, this.formData.banner_imgs);
